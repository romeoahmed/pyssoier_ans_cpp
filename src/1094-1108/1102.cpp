...
int main(int argc, char const* argv[]) {
    constexpr std::array<std::string_view, 3> winCombinations{"Rock Scissors", "Scissors Paper",
                                                              "Paper Rock"};

    constexpr std::array<std::string_view, 3> tieCombinations{"Rock Rock", "Scissors Scissors",
                                                              "Paper Paper"};
